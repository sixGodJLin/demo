...
/**
 * Created by NeuroAndroid on 2017/11/14.
 */
...
public class SystemBarHelper {
    ...
    public static void setStatusBarDarkMode(Window window, boolean darkMode) {
        if (isFlyme4Later()) {
            ...
            setStatusBarDarkModeForMIUI(window, darkMode);
     ...
     */
    public static void setStatusBarDarkModeForMIUI(Window window, boolean darkMode) {
        if (window != null) {
