...
public class ToggleUtil {
     ...
     */
    public static ToggleUtil newInstance(Context context, View hideView, int height) {
        return new ToggleUtil(context, hideView, height);
    }

    private ToggleUtil(Context context, View hideView, int height) {
