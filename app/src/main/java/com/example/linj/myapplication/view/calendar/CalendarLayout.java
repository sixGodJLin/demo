    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                System.out.println("CalendarLayout " + "onTouchEvent " + "----" + mContentView.getTranslationY());
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                break;
            case MotionEvent.ACTION_MOVE:
                System.out.println("CalendarLayout " + "onInterceptTouchEvent " + "----" + mContentView.getTranslationY());
        ...
        if (mContentView != null && mMonthView != null) {
            ...
            if (monthHeight >= height && mMonthView.getHeight() > 0) {
                ...
                heightMeasureSpec = MeasureSpec.makeMeasureSpec(monthHeight +
                        CalendarUtil.dipToPx(getContext(), 41), MeasureSpec.EXACTLY);
